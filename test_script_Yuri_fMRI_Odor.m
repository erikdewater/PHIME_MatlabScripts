...
matlabbatch2{1}.spm.stats.fmri_spec.sess.cond(1).name = 'Odor';
...
matlabbatch2{1}.spm.stats.fmri_spec.sess.cond(2).onset = [20
                                                         ...
                                                         180
                                                         220];
matlabbatch2{1}.spm.stats.fmri_spec.sess.cond(2).duration = 20;
...
matlabbatch2{3}.spm.stats.con.consess{1}.tcon.name = 'Odor>rest';
...
matlabbatch2{3}.spm.stats.con.consess{2}.tcon.name = 'rest>Odor';
